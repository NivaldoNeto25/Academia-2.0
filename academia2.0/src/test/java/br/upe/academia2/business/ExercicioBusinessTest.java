...
class ExercicioBusinessTest {
    ...
    @Mock
    private ExercicioJpaRepository exercicioRepositoryMock;
    ...
    void setUp() throws Exception {
        ...
        Field field = ExercicioBusiness.class.getDeclaredField("exercicioRepository");
        field.setAccessible(true);
        field.set(exercicioBusiness, exercicioRepositoryMock);
    }
    ...
    void testSalvar_ComExercicioValido_DeveChamarCreate() {
        ...
        when(exercicioRepositoryMock.findByNome("Supino Reto")).thenReturn(null);
        ...
        // Assert
        verify(exercicioRepositoryMock, times(1)).findByNome("Supino Reto");
        verify(exercicioRepositoryMock, times(1)).create(novoExercicio);
    }
    ...
    void testSalvar_ComExercicioExistente_NaoDeveChamarCreate() {
        ...
        when(exercicioRepositoryMock.findByNome("Agachamento")).thenReturn(exercicioExistente);

        // Act
        exercicioBusiness.salvar(exercicioExistente);

        // Assert
        verify(exercicioRepositoryMock, times(1)).findByNome("Agachamento");
        verify(exercicioRepositoryMock, never()).create(any(Exercicio.class));
    }
    ...
    void testSalvar_ComNomeVazio_NaoDeveChamarCreate() {
        ...
        // Assert
        verify(exercicioRepositoryMock, never()).findByNome(anyString());
        verify(exercicioRepositoryMock, never()).create(any(Exercicio.class));
    }
    ...
    void testListarExercicios_DeveRetornarListaDoRepositorio() {
        ...
        when(exercicioRepositoryMock.findAll()).thenReturn(listaEsperada);
        ...
        verify(exercicioRepositoryMock, times(1)).findAll();
    }
    ...
    void testBuscarExercicioPorNome_QuandoEncontrado_DeveRetornarExercicio() {
        ...
        when(exercicioRepositoryMock.findByNome("Leg Press")).thenReturn(exercicio);

        // Act
        Exercicio resultado = exercicioBusiness.buscarExercicioPorNome("Leg Press");

        // Assert
        verify(exercicioRepositoryMock, times(1)).findByNome("Leg Press");
        assertNotNull(resultado);
    ...
    void testBuscarExercicioPorNome_QuandoNaoEncontrado_DeveRetornarNulo() {
        // Arrange
        when(exercicioRepositoryMock.findByNome("Inexistente")).thenReturn(null);
    ...
    void testAtualizarExercicio_ComExercicioValido_DeveChamarUpdate() {
        ...
        // Assert
        verify(exercicioRepositoryMock, times(1)).update(exercicio);
    }
    ...
    void testAtualizarExercicio_ComExercicioNulo_NaoDeveChamarUpdate() {
        ...
        // Assert
        verify(exercicioRepositoryMock, never()).update(any());
    }
    ...
    void testDeletarExercicio_ComNomeValido_DeveChamarDelete() {
        ...
        // Simulamos que o delete retornou true (sucesso)
        when(exercicioRepositoryMock.delete(nomeParaDeletar)).thenReturn(true);

        // Act
        exercicioBusiness.deletarExercicio(nomeParaDeletar);

        // Assert
        verify(exercicioRepositoryMock, times(1)).delete(nomeParaDeletar);
    }
    ...
    void testDeletarExercicio_ComNomeVazio_NaoDeveChamarDelete() {
        ...
        // Assert
        verify(exercicioRepositoryMock, never()).delete(anyString());
    }
}